...
Ten en cuenta que la plantilla de creación es diferente. En el último paso (**Adopt good practice** se llama en inglés) le pasamos el `padding` de `Scaffold` (innerPadding) ya no tenemos ningún `Surface`. NO

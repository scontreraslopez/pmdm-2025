...
Para usarlas en Android, necesitarás dos conceptos clave: **Scope** y **Dispatchers**.

-----

### 3. CoroutineScope (El "Quién" y "Cuándo")
...
Vamos a seguir los codelabs: https://developer.android.com/courses/android-basics-compose/unit-6